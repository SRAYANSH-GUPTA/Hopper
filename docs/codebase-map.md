...
| Provider first-launch setup, installation, sign-in, and readiness | `src/features/provider-setup/components/ProviderSetup.tsx`, `src/features/app/hooks/useProviderSetup.ts`, `src-tauri/src/shared/provider_setup_core.rs`, `src-tauri/src/provider_setup.rs`, `src-tauri/src/bin/hopper_daemon/rpc/provider_setup.rs`, `docs/provider-setup.md` |
